...
import {JavaScript} from 'blockly/index'
 ...
 JavaScript['Run Car'] = function(block) {
...
//  let code = 'digitalWrite(5,' + direction + ');\n' + 'analogWrite(2,' + Math.floor(value*2.55) + ');\n';
 ...
 JavaScript['Drive Car'] = function(block) {
...
//  let code = 'digitalWrite(5,' + direction + ');\n' + 'analogWrite(2,' + Math.floor(value*2.55) + ');\n';
 ...
 JavaScript['Turn Car'] = function(block) {
  let direction = block.getFieldValue('direction');
 ...
 JavaScript['Headlights'] = function(block) {
 ...
 JavaScript['HeadlightManual'] = function(block) {
 ...
 JavaScript['BacklightManual'] = function(block) {
  let value = block.getFieldValue('value');
 ...
 JavaScript['IR VALUE'] = function(block) {
...
//  let code = 'digitalRead(' + value + ')';
 ...
 JavaScript['While'] = function(block) {
  let value_code =  JavaScript.statementToCode(block, 'LHS')
  let rhs = block.getFieldValue('RHS');
  let op = block.getFieldValue('condition');
  let stmt_code =  JavaScript.statementToCode(block, 'steps')
 ...
 JavaScript['Else If'] = function(block) {
  let value_code =  JavaScript.statementToCode(block, 'LHS')
  let rhs = block.getFieldValue('RHS');
  let op = block.getFieldValue('condition');
  let stmt_code =  JavaScript.statementToCode(block, 'steps')
 ...
 JavaScript['Else'] = function(block) {
  let stmt_code =  JavaScript.statementToCode(block, 'steps')
 ...
 JavaScript['root'] = function(block) {
  let setup_code =  JavaScript.statementToCode(block, 'setup')
  let loop_code =  JavaScript.statementToCode(block, 'loop')
 ...
 JavaScript['delay_in_seconds'] = function(block) {
